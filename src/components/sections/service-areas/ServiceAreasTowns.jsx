...
export default function ServiceAreasTowns() {
  const towns = [
    {
      name: "Anderson, SC",
      img: "/service-areas/anderson.webp",
    ...
    {
      name: "Greenville, SC",
      img: "/service-areas/greenville.webp",
    ...
    {
      name: "Clemson, SC",
      img: "/service-areas/clemson.webp",
    ...
    {
      name: "Pendleton, SC",
      img: "/service-areas/pendleton.webp",
    ...
    {
      name: "Williamston, SC",
      img: "/service-areas/williamston.webp",
    ...
    {
      name: "Liberty, SC",
      img: "/service-areas/liberty.webp",
    ...
    {
      name: "Pickens, SC",
      img: "/service-areas/pickens.webp",
