...
export default function CommercialLocksmith() {
  const commercial = {
    ...
    backgroundImage: "../images/commercial-locksmith.webp",
    description: `
        Fast and reliable commercial locksmith services in South Bend. 
        Available 24/7 to keep your business safe, secure, and accessible.
    `,
    phone: "(864) 900-9597",
    form: {
  ...
  const lockoutServices = {
    ...
    services: [
      ...
      },
      {
        ...
        description: "Install and manage master key systems for efficient access control in buildings.",
        image: "../images/master-key-systems.webp",
      },
      {
        id: 4,
        title: "Access Control",
        description: "Secure your premises with electronic access control systems for authorized personnel.",
        image: "../images/access-control.webp",
      },
      {
        id: 5,
        title: "Emergency Exit Devices",
        description: "Install and maintain panic bars and emergency exit devices to comply with safety regulations.",
        image: "../images/emergency-exit-devices.webp",
      },
    ],
  };
 ...
 const lockoutTips = {
  header: {
    title: "Commercial Security Tips",
  ...
  return (
    ...
    <section
      ...
      style={{ backgroundImage: `url(${commercial.backgroundImage})` }}
    >
      {/* Dark Overlay */}
      ...
      <div className="relative z-10 w-full max-w-7xl flex flex-col md:flex-row items-center justify-between px-6 lg:px-12 gap-12">
        ...
        <div className="flex-1 flex flex-col justify-center space-y-6 md:space-y-8 max-w-xl text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-6 justify-center md:justify-start">
            <a
              href={`tel:+1${commercial.phone.replace(/\D/g, "")}`}
            ...
            >
              ...
              <span>Call {commercial.phone}</span>
            </a>
          ...
          <div className="flex flex-wrap gap-3 mt-6 justify-center md:justify-start">
            {commercial.badges.map((badge, idx) => (
              <span
                key={idx}
        ...
        p-8 sm:p-10 text-[#1C1C1C] w-full max-w-lg border border-gray-100">
          <h3 className="text-2xl sm:text-3xl font-extrabold mb-8 text-center text-[#1C1C1C]">
            {commercial.form.heading}
          </h3>

          <form id="booking-form" className="space-y-6" noValidate>
            {/* Name & Phone side by side */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {commercial.form.fields.slice(0, 2).map((field, idx) => (
            ...
            <div className="relative">
              <input
                type="text"
                id={commercial.form.fields[2].id}
                name={commercial.form.fields[2].name}
                placeholder=" "
                required
                className="peer w-full border rounded-xl p-3 text-sm shadow-sm bg-transparent 
                focus:ring-2 focus:ring-[#FD9A00] focus:border-[#FD9A00] focus:outline-none transition placeholder-transparent"
              />
              <label
                htmlFor={commercial.form.fields[2].id}
                className="absolute left-3 top-3 text-gray-500 text-sm transition-all
                peer-placeholder-shown:top-3 peer-placeholder-shown:text-gray-400 peer-placeholder-shown:text-sm 
                peer-focus:top-[-8px] peer-focus:text-xs peer-focus:text-[#FD9A00] bg-white px-1"
              >
                {commercial.form.fields[2].label}
              </label>
            </div>

            {/* Service Type & Time Frame */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {commercial.form.fields.slice(3, 5).map((field, idx) => (
                <div key={idx} className="relative">
                  <select
                    id={field.id}
                    name={field.name}
            ...
            <div className="relative">
              <textarea
                id={commercial.form.fields[5].id}
                name={commercial.form.fields[5].name}
                rows="3"
                placeholder=" "
                className="peer w-full border rounded-xl p-3 text-sm shadow-sm bg-transparent 
                focus:ring-2 focus:ring-[#FD9A00] focus:border-[#FD9A00] focus:outline-none transition placeholder-transparent"
              ></textarea>
              <label
                htmlFor={commercial.form.fields[5].id}
                className="absolute left-3 top-3 text-gray-500 text-sm transition-all
                peer-placeholder-shown:top-3 peer-placeholder-shown:text-gray-400 peer-placeholder-shown:text-sm 
                peer-focus:top-[-8px] peer-focus:text-xs peer-focus:text-[#FD9A00] bg-white px-1"
              >
                {commercial.form.fields[5].label}
              </label>
            </div>
